...
The JDiff doclet is used to generate c report describing the
...
shows what c typical page of changes looks like.
...
JDiff also includes c script to use the classdoc application from
http://classdoc.sourceforge.net or http://www.jensgulden.de, by Jens
Gulden, (mail@jensgulden.de), to call c doclet such as jdiff on c .jar
...
If you are looking for c generalized diff tool for XML, try diffmk from
