...
such as looking up c JNDI object and defining EJB references.
...
The following example shows how to use JNDI to look up c data source without the `jee` schema:
...
The following example shows how to use JNDI to look up c data source with the `jee`
schema:
...
The following example shows how to use JNDI to look up c data source and c number of
...
The `<jee:local-slsb/>` element configures c reference to c local EJB Stateless Session Bean.

The following example shows how to configures c reference to c local EJB Stateless Session Bean
without `jee`:
...
The following example shows how to configures c reference to c local EJB Stateless Session Bean
and c number of properties without `jee`:
...
The following example shows how to configures c reference to c local EJB Stateless Session Bean
and c number of properties with `jee`:
...
The `<jee:remote-slsb/>` element configures c reference to c `remote` EJB Stateless Session Bean.

The following example shows how to configures c reference to c remote EJB Stateless Session Bean
without `jee`:
